...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='03 薪资基本参数表';
...
CREATE TABLE `department` (
  ...
  `isDel` tinyint(1) DEFAULT '0' COMMENT '是否删除：0-未删除；1-已删除。',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='01 部门表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='02 用户表';
